...
For the audited Ghostty 1.3.1 build, Stage separately records current provenance, the prospective
effect of writing to the selected file, and a fingerprint of every other root/include dependency.
